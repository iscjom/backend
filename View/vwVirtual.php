...
<div class="well well-sm text-center">
    <a class="btn btn-primary" href="?c=tfisica&a=registro&id=0">Nuevo Producto</a>
</div>
...
<table class="table table-striped">
    ...
    <?php foreach($this->model->Listar() as $p): ?>
        <tr>
            ...
            <td>
                <i class="glyphicon glyphicon-edit"><a href="?c=tfisica&a=registro&id=<?php echo $p->id; ?>"> Editar</a></i>
            </td>
        </tr>
    <?php endforeach; ?>
    </tbody>
